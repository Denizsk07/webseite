    ...
    <FloatingNav navItems={navItems} />
      <div className="relative overflow-hidden h-full flex flex-col items-center justify-center min-h-screen w-full p-4 space-y-10">
        ...
        <Spotlight
          ...
          fill="neutral-700"
        />
        <Spotlight className="absolute left-80 top-28 h-[80vh] w-[50vw]" fill="accent" />
        <div className="text-center relative z-10">
          <h1 className="text-0,4 md:text-0,5xl font-bold text-foreground animate-fade-in leading-tight">
           -München-
          </h1>
          ...
          <Link href="#projects">
          <button className="mt-6 px-8 py-3 bg-primary text-white font-bold rounded-full hover:bg-purple-700 transition-all duration-300 animate-fade-in">
